...
const AutoComplete: React.FC<BaseTextProps> = (props) => {
  ...
  return (
    <div className={classes}>
      {showLabel && (
        <div className={styles['auto-simple-input-container-title']}>
          {children}{' '}
          {required && (
      ...
      <div className={searchContainer}>
        ...
        {inputValue && (<div className={styles['search-clear']} onClick={() => {
          setInputValue('');
          onSelect({
            value: "World Wide",
            state: "World Wide",
        ...
        {showDropdown && (
          <div className={styles['showDropdown-area']}>
            {/* <div
              ...
              onClick={(e) => {
                e.stopPropagation();
                if (clientCurrentLocation) {
                  clientCurrentLocation();
                }
              }}
            >
              <div className={styles['current-location-icon']}>
                <Image src={NavigationArrow} layout="fill" />
              </div>
              <div className={styles['current-location-title']}>
                Current location
              </div>
            </div> */}
